...
let projects = [
  {
    ...
    url: 'https://bfdec62d-60e3-49b0-a1c4-7a74f121cc7c-00-d9g68qwbp2gx.riker.replit.dev/',
  },
  {
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('HIMASTER', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Web Designer / Robotik / Content Creator',
      {
        font: font,
        size: 0.018,
        height: 0,
